...
import * as actionCreator from "../redux-og";
...
const App = () => {
  ...
  const handleCreateNewTodo = (e: FormEvent<HTMLFormElement>): void => {
    ...
    dispatch(actionCreator.createTodoActionCreator({ desc: newTodoInput }));
    setNewTodoInput("");
  };

  const handleSelectTodo = (todoId: string): void => {
    dispatch(actionCreator.selectTodoActionCreator({ id: todoId }));
    setIsEditMode(false);
  };
  ...
  const handleUpdate = (e: FormEvent<HTMLFormElement>): void => {
    ...
    dispatch(
      actionCreator.editTodoActionCreator({
        id: selectedTodoId,
        desc: editTodoInput,
      })
    );
  ...
  const handleToggle = (): void => {
    ...
    dispatch(
      actionCreator.toggleTodoActionCreator({
        id: selectedTodoId,
  ...
  const handleDelete = (): void => {
    ...
    dispatch(actionCreator.deleteTodoActionCreator({ id: selectedTodoId }));
  };
